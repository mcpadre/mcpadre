...
import { updateCursorConfig } from "./cursor.js";
...
describe("updateCursorConfig", () => {
  ...
  it("creates new config when existing content is empty", () => {
    const result = updateCursorConfig("", mockServers);
  ...
  it("preserves existing non-mcpadre servers when updating", () => {
    ...
    const result = updateCursorConfig(existingConfig, mockServers);
  ...
  it("preserves other config properties outside mcpServers", () => {
    ...
    expect(parsed.cursorSettings).toEqual({ theme: "dark" });
  ...
  it("handles malformed JSON by creating new config", () => {
    ...
    const result = updateCursorConfig(malformedJson, mockServers);
  ...
  it("handles empty servers object", () => {
    const result = updateCursorConfig("", {});
